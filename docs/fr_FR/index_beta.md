...
Celle-ci comprend le nom de la donnée et la référence interne définie dans l'écocompteur. Le fichier en lien JSON_Codes.txt donne une liste non exhautive des références utilisables.
